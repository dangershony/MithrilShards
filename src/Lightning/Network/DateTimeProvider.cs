...
namespace Network
{
   public class DateTimeProvider : IDateTimeProvider
   {
      ...
      **************************************************************
      ...
      private const long UnixEpochTicks = 719_162 * TimeSpan.TicksPerDay;
      private const long UnixEpochMicroseconds = UnixEpochTicks / TimeSpan.TicksPerMillisecond;
      ...
      /// </summary>
      public DateTimeProvider(ILogger<DateTimeProvider> logger, IOptions<LightningNodeSettings> options)
      {
         this.logger = logger;
      ...
      {
         if (!this.autoAdjustingTimeEnabled)
         {
