...
namespace Network
{
   public class DateTimeProvider : IDateTimeProvider
   {
      ...
      **************************************************************
      ...
      private const long UNIX_EPOCH_TICKS = 719_162 * TimeSpan.TicksPerDay;
      private const long UNIX_EPOCH_MICROSECONDS = UNIX_EPOCH_TICKS / TimeSpan.TicksPerMillisecond;
