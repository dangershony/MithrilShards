...
namespace Network.Protocol.Transport.Noise
{
	...
	{
		private static readonly CurveSecp256K1 dh = new CurveSecp256K1();
		...
		public byte[] PrivateKey
		{
			get
			{
				Exceptions.ThrowIfDisposed(this.disposed, nameof(KeyPair));
		...
		public void Dispose()
		{
			if (!this.disposed)
			{
				Utilities.ZeroMemory(this.privateKey);
				this.disposed = true;
			}
		}
	}
