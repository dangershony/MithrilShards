...
namespace Network.Protocol.Transport.Noise
{
   ...
   public interface IHandshakeState : IDisposable
   {
      ...
      /// <param name="config">A set of parameters used to instantiate a <see cref="ObjectDisposedException"/>.</param>
      /// <exception cref="ArgumentNullException">
      /// Thrown if the current instance has already been disposed.
      /// </exception>
      /// <exception cref="ArgumentNullException">
      /// Thrown if either <paramref name="config"/> or <paramref name="config"/> is null.
      /// </exception>
      /// <exception cref="ArgumentException">
      /// Thrown if <paramref name="protocol"/> is not XXfallback,
      /// or if the provided local static private key is empty.
      /// </exception>
      /// <exception cref="IHandshakeState">
