...
{
   public class TransportConnectivitySettings : MithrilShardSettingsBase
   {
      private const int DEFAULT_MAX_INBOUND_CONNECTIONS = 20;
      private const int DEFAULT_MAX_OUTBOUND_CONNECTIONS = 20;
      private const bool DEFAULT_ALLOW_LOOPBACK_CONNECTION = true;
      private const int DEFAULT_FORCE_SHUTDOWN_AFTER = 300;
      private const int DEFAULT_BAN_SCORE = -100;
      private const int DEFAULT_MISBEHAVING_BAN_TIME = 60 * 60 * 24; // 24 hours
      ...
      public List<TransportPeerBinding> Listeners { get; } = new List<TransportPeerBinding>();
