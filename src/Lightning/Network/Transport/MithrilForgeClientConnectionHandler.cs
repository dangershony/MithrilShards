...
namespace MithrilShards.Network.Bedrock
{
   public class MithrilForgeClientConnectionHandler : ConnectionHandler
   {
      ...
      public override async Task OnConnectedAsync(ConnectionContext connection)
      {
         ...
         var lightningEndpoint = connection.Features.Get<LightningEndpoint>();

         var NoiseProtocol = new NoiseProtocol() { Initiator = true, RemotePubKey = lightningEndpoint.NodePubkey };
         ...
         NetworkPeerContext networkPeerContext = peerContext as NetworkPeerContext;
         networkPeerContext.HandshakePotocol = NoiseProtocol;
