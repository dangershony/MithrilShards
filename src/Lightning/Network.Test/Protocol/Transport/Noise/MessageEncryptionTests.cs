    ...
    public class MessageEncryptionTests
    {
            ...
            byte[] s = null, byte[] rs = null)
        {
            return new HandshakeState<ChaCha20Poly1305, CurveSecp256K1, Sha256>(
                Network.Protocol.Transport.Noise.Protocol.Parse(LightningNetworkConfig.ProtocolName), isInitiator,
        ...
        {
            var outputBuffer = new byte[Network.Protocol.Transport.Noise.Protocol.MaxMessageLength];
